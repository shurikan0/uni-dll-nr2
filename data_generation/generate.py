...
def parse_args(args=None):
    ...
    parser.add_argument("-e", "--env-id", type=str, default="StackCube-v1", help=f"Environment to run motion planning solver on. Available options are {list(MP_SOLUTIONS.keys())}")
    ...
    parser.add_argument("--traj-name", type=str, default="trajectory2", help="The name of the trajectory .h5 file that will be created.")
